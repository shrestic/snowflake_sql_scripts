...
-- lets quickly understand the const
    drop table if exists my_constraints_table;
    ...
    insert into my_constraints_table (fname,lname,unique_code)
    values   ('John3','K','1000');
    
    -- below throws error as non-null column value is missing
    insert into my_constraints_table (emp_pk,fname,unique_code)
